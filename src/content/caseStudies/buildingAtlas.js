const buildingAtlas = {
	...
	summary: [
		...
		"The honest framing on AI-native design: it's like working with a very capable junior who has no taste and infinite energy. They execute exactly what you specify, immediately, without pushback — which means vague direction produces fast mediocre work that you now have to unpick. The quality of your feedback, every iteration, is what determines whether the output is any good. Design expertise isn't optional in this loop; it's the whole point.",
	],
	sections: [
		{
			title: "The problem",
		...
		{
			title: "What AI-native design actually looks like",
			paragraphs: [
				...
				"The feedback loop is constant. Every iteration requires a design eye. Every push requires a review. The AI will confidently implement something that is technically correct and visually wrong. If you're not catching it, it compounds. I spent real time undoing work that had drifted: not because the AI made a mistake, but because I hadn't been specific enough.",
				"What this means in practice: the speed gains are real, but they require design expertise to unlock. The AI amplifies whatever direction you give it. Good direction, fast good output. Vague direction, fast mediocre output that you now have to unpick.",
		...
		{
			title: "Figma Make vs. Cursor: the decision that mattered",
			paragraphs: [
				...
				"The problem: the output lives in Figma. There is no path from a Figma Make prototype to a production codebase that doesn't require a full rebuild. Engineering gets a visual reference, not working code.",
				"Cursor's output lives in the codebase. Engineering could fork from the working branch. The prototype and the product converged rather than diverging. That justified the learning curve of moving the design process into a new environment.",
			],
		},
		{
			title: "Making it work for the team, not just for design",
			paragraphs: [
				...
				"Fixing it meant treating this as a team process, not a design tool. I updated the PDLC to account for how handoff worked now. Three environments with explicit contracts:",
			],
			list: [
				"eng-ready: stable, what engineering builds from, updated on a schedule with advance notice",
				"wip: active design work only, no guarantees",
				"concept-testing: frozen during active research sessions",
			],
			paragraphs: [
		...
		},
		{
			...
			image: {
				...
				caption: "SharonMiller #1 contributor to the prototype repo. cursoragent #2. What AI-native IC work looks like in the commit graph.",
			},
			video: {
